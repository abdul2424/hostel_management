...
<body>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="flipModalLabel">Logout</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary  " href="{{route('adminlogin')}}">Save Changes</button>
                    </div>
    ...
    <!-- Theme Settings -->
    @include('admin.partial.theme_setting')
